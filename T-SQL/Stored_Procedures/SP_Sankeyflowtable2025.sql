...
-- =============================================
CREATE PROCEDURE [dbo].[SP_Sankeyflowtable2025]--<Procedure_Name, sysname, ProcedureName> 
...
select * into ##Lic_2025 from Lic_2025 
--select * from ##Cust_2025
--select * from ##Permits_2025

drop table if exists ##Permits_2025;
With Permits_2025 as (
select 
...
select * into ##Permits_2025 from Permits_2025

DROP TABLE if exists ##Cust_License_Permit_2025
...
into ##Cust_License_Permit_2025
from ##Lic_2025 a
left join ##Permits_2025 b on b.customerid=a.customerid --636731

drop table if exists [dbo].[Sankey_flow_table_2025];
WITH AllLicenses AS (
...
SELECT * INTO [dbo].[Sankey_flow_table_2025]
FROM AllLicenses
UNION ALL
